...
### 27 面试 套路
```
一般面试，都是先让你自我介绍，说一下你做的业务，然后技术栈用了哪些，会分别问一下。
既然是这样，那你可以按这个套路准备，问自己问题，我的项目用了什么技术，为什么要用这个技术？原理是什么？为什么不用别的？
用这个技术会出现一些什么问题，这些问题是如何解决的？
你可以尝试着挑一个技术框架或者一个技术知识点，问一下自己这些问题，不会的去查，你会发现你会学到很多东西。

```
```
在面你中意的公司之前，一定要找几个练手的，并且工资要的比你期待的工资高一点（比如你期待的是一万五，那你要一万八或者两万）。
这些公司，只面试，不管成不成，都不去，失败了即使面的灰头土脸，
也不要有心理压力，就是练手的，调节一下心态，成功了也不要有心理负担，毕竟企业有时候也会把你当备胎，有的人总觉得别人要你了，不去不好意思。
```
